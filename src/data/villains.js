export const villains = [
  {
    ...
    paragraphs: [
      ...
      "It stands no taller than a child, but there is nothing childlike in the way it holds itself. Its posture is coiled, predatory, a killer's stillness right before the strike.",
      "Then it moves. Faster than anything that size should be able to move, it lunges, jaws snapping, claws outstretched for your throat.",
      "There's no time to think, only to choose. Rock. Paper. Scissors. Your fate against its is decided in the space of a heartbeat.",
    ],
  },
  {
    id: "frost-knight",
    ...
    paragraphs: [
      ...
      "The sword sparkles with ice, and sheets of cold swirl around its edge, frosting the grass where its shadow falls. His helmet is a bare, bony skull, locked in an eternal scream of terror, as though the metal itself remembers dying.",
      "The {{frost knight}} advances on you coldly, silently, and then closes the distance with the speed of lightning. There is no time to run. You must defend yourself.",
    ],
  },
  {
    id: "spider",
    ...
    paragraphs: [
      ...
      "Then it drops. A {{giant spider}}, easily the size of a car, fangs curved and glistening like death given shape. Its many eyes lock onto you, and there is nothing in them but hunger.",
      "It wants to devour you, and it isn't going to wait. You have seconds to fight, and seconds to live.",
    ],
  },
  {
    id: "wight",
    ...
    paragraphs: [
      ...
      "As shadow hardens into flesh, the smell of rot and decay rolls over you in a wave, thick enough to suffocate, thick enough to taste.",
      "It opens its bony maw, jaw unhinging wider than any living thing should allow, and lunges to devour not your flesh, but your very soul.",
    ],
  },
  {
    id: "dragon",
    ...
    paragraphs: [
      ...
      "It lands.",
      "A mountain of flesh and hardened scale, wings folding like collapsing cathedrals, a {{dragon}} whose sheer size swallows your entire view.",
      "With one mighty roar that deafens you and shakes the ground beneath your feet, it charges.",
    ],
  },
];
